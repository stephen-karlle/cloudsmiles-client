...
const ReviewRequestInformationStep = () => {
  ...
  return (
    <section className="w-full h-full flex flex-col overflow-y-scroll px-6 py-4 overflow-x-hidden outline-none ">
      <label className="text-lg font-medium text-gray-700 tracking-tight mb-2">Request Information</label>
      <label className="text-sm font-medium text-gray-500 tracking-tight">Request Name</label>
      <Controller
        name="contextLabel"
        control={control}
...
export default ReviewRequestInformationStep
...
import useAddNewDentist from '../../hooks/useAddNewDentist'

const AddNewDentistForm = () => {

  const methods = useAddNewDentist()
  ...
  const validateServicesStep = async () => {
    const isServicesStepValid = await trigger(["dentistMedicalServices", "dentistCosmeticServices"]); 
...
export default AddNewDentistForm

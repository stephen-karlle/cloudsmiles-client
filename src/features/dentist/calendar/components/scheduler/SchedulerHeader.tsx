...
const SchedulerHeader = ({ 
  ...
  const date = useDentistCalendarStore((state) => state.date)
  const setDate = useDentistCalendarStore((state) => state.setDate)
  ...
  return (
    <header className="sticky top-0 h-20 z-[60] w-full flex items-center justify-between gap-2 p-6 bg-white border-b border-ring-200">

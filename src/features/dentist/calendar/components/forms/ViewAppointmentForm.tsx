...
const ViewAppointmentForm = () => {
  ...
  const selectedAppointment = useDentistCalendarStore((state) => state.selectedAppointment)
          ...
          <div className="flex flex-col items-center justify-center rounded-md w-full ring-1 ring-gray-200"> 
            <div className="flex items-center justify-between w-full">
              ...
              <div className="w-40  flex items-center justify-center gap-2"> 
                ...
                <label className={`  px-2 py-1 uppercase text-xs rounded-full  text-green-500 bg-green-50  `}>Verified</label>
              </div>
            </div>
